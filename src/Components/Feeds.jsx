...
const Feeds = (props) => {
    ...
    return ( 
       ...
       currentUser?
        <div className="uploadAudio" style={{ height:"fit-content",backgroundImage: "url(" + "https://g.foolcdn.com/editorial/images/471519/print-newspaper.jpg" + ")",
        backgroundSize: 'cover'}}>
         
        
         <div style={{display:"flex",justifyContent:"space-between"}} >
              <div >
                  <input style={{color:"white"}} type="file" accept="video/*" onChange={handleInputFile}/>
                  <label>
                      <Button onClick={handleUploadFile} variant="contained" color="secondary" >UPLOAD</Button>
                  </label>
                  <Typography style={{color:"white"}} variant="h5">Welcome back !!</Typography>
                  <Typography style={{color:"white"}} variant="h5">Upload the latest update</Typography>
         ...
         <div className="uploadAudio" style={{
          height:"fit-content",
         backgroundImage: "url(" + "https://g.foolcdn.com/editorial/images/471519/print-newspaper.jpg" + ")",
         backgroundSize: 'cover'
         }}>
