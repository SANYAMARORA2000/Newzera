...
const Profile = (props) => {
  const useStyles = makeStyles({
    ...
    {
       height:"100rem",
       backgroundImage: "url(" + "https://s1.1zoom.me/big0/436/Closeup_Many_Newspaper_569012_1280x854.jpg" + ")",
  ...
  let classes = useStyles();
    ...
    return ( 
        ...
        <div className={classes.headingdiv}>
              ...
              <Typography style={{ color:"white"}}variant="h5">{user ?user.username : ""} </Typography> 
              </div>
